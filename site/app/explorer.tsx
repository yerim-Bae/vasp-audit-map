...
type MainView = 'explore' | 'compare' | 'checklist';
type ListTab = 'active' | 'expired';
const marketFilters = ['전체', '원화마켓', '코인마켓', '시장유형 미확인'];
...
export default function Explorer({ datasets }: { datasets: Datasets }) {
  ...
  const sourceList = listTab === 'active' ? activeVasps : expiredVasps;
